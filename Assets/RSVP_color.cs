...
namespace TMPro.Examples
{
    ...
    public class RSVP_color : MonoBehaviour
    {
        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            Color32 pivotColor = new Color32(125, 226, 209, 255); // Teal RGBP
            Color32 origColor = new Color32(240, 235, 236, 255); // Light Gray RGBP
