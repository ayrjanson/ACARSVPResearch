...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    internal class AnchorSubsystem : XRAnchorSubsystem
    {
        ...
        private class OpenXRProvider : Provider
        {
            ...
            {
                // Anchor subsystem maybe stopped when ARAnchorManager is destroyed as result of Unity scene switching
                // We should sync the native library anchor provider state to clear transient anchors, so next time
                // when subsystem starts in a new scene it starts with fresh new set of anchors.
                // Application must use some anchor persistent tech to keep anchor localized, or keep the Anchor subsystem alive.
                NativeLib.ClearAnchorChanges(nativeLibToken);
            }
